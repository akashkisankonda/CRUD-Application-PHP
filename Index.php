...
<html lang="en">
   ...
   <body>
      <table class="table table-striped table-hover table-md-responsive text-center">
         <tr class="table-dark">
            <th>Login Id</th>
            <th>Name</th>
            <th>Phone</th>
...
?>
         <tr>
            ...
            <td><a href="/Assignment/?DLoginId=<?php echo $row["Login Id"]; ?>"><button class="btn btn-primary"> View Transactions </button> </a> <a href="/Assignment/?DeletCustomer=<?php echo $row["Login Id"]; ?>"><button class="btn btn-danger"> Delete  </button></a></td>
         </tr>
         <?php
    }
}
?>
         <tr class="table-dark">
            <td colspan="4"> <strong><?php echo "$rowcount customers"; ?></strong></td>
         </tr>
      </table>
...
if (!empty($_GET["DLoginId"])) {
    ...
    if (strlen($LoginId) > 1) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if (mysqli_num_rows($result) > 0) {
?>
      <h6 class="display-6 text-center pt-5">Below are the transactions for selected LoginID <mark> <?php echo $_GET['DLoginId']; ?> </mark> </h6>
      <table class="table table-striped table-hover table-md-responsive text-center">
         <tr class="table-dark">
...
?>
         <tr>
            ...
            <td><?php echo $row['Total'];
                    $OverallTotal+= $row['Total']; ?></td>
            <td><?php echo $row['Date']; ?></td>
            <td> <a href="/Assignment/?DeletTransaction=<?php echo $row['Invoice Number']; ?>"> <button type="button" class="btn btn-danger"> Delete </button></a></td>
         </tr>
         <?php
                }
?>
         <tr class="">
            <td colspan="5" class="text-end"> <strong><?php echo "Overall Total is $OverallTotal"; ?></strong></td>
         </tr>
         <tr class="table-dark">
            <td colspan="7"> <strong><?php echo "$rowcount transactions"; ?></strong></td>
         </tr>
      </table>
      <!-- btn  -->
      <div class="btn-group d-grid gap-3">
         <button type="button" class="btn btn-secondary d-block" data-bs-toggle="modal" data-bs-target="#UpdateTransaction">
         Update Transaction
         </button>
      </div>
      <?php
...
?>
      <div class="alert alert-danger show fade mt-5 text-center">
         No Transactions Available For Customer LoginID <?php echo $_GET['DLoginId']; ?>
      </div>
      <?php
            }
        }
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     ...
                     <div class="form-floating mb-3 mt-3">
                        ...
                        <label for="email">Login Id <small class="text-danger"><?php echo "min $MinLoginIDLength length, max $MaxLoginIDLength length (Only Numbers)" ?></small></label>
                     </div>
                     <div class="form-floating mt-3 mb-3">
                        <input type="text" class="form-control" placeholder="Enter Name" name="Name">
                        <label>Name <small class="text-danger"><?php echo "min $MinCustomerNameLength length, max $MaxCustomerNameLength length" ?></small></label>
                     </div>
                     <div class="form-floating mt-3 mb-3">
                        <input type="text" class="form-control" placeholder="Enter Phone" name="Phone">
                        <label>Phone <small class="text-danger"><?php echo "min $MinPhoneNumberLength length, max $MaxPhoneNumberLength length (Only Numbers)" ?></small></label>
                     </div>
                  </div>
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     ...
                     <div class="form-floating mt-3 mb-3">
                        ...
                        <label>Product Name <small class="text-danger"><?php echo "min $MinProductNameLength length, max $MaxProductNameLength length" ?></small></label>
                     </div>
                     <div class="form-floating mt-3 mb-3">
                        <input type="text" class="form-control" placeholder="Enter Price" name="PPrice">
                        <label>Product Price <small class="text-danger"><?php echo "min $MinProductPriceLength length, max $MaxProductPriceLength length (Only Numbers)" ?></small></label>
                     </div>
                     <div class="form-floating mt-3 mb-3">
                        <input type="text" class="form-control" placeholder="Enter Quantity" name="PQuantity">
                        <label>Product Quantity <small class="text-danger"><?php echo "min $MinProductQuantityLength length, max $MaxProductQuantityLength length (Only Numbers)" ?></small></label>
                     </div>
                  </div>
                  <div class="modal-footer">
                     <button type="submit" class="btn btn-primary">Submit</button>
               ...
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     ...
                     <div class="form-floating mb-3 mt-3">
                        ...
                        <label for="email">Invoice Number <small class="text-danger"><?php echo "min $MinInvoiceNumberLength length, max $MaxInvoiceNumberLength length (Only Numbers)" ?></small></label>
                     </div>
                     <div class="form-floating mt-3 mb-3">
